...
import { H as HTTPError, d as defineHandler, h as handleCacheHeaders, t as toResponse, a as defineLazyEventHandler, b as H3Core } from "./_libs/h3.mjs";
...
const findRouteRules = /* @__PURE__ */ (() => {
  const $0 = [{ name: "headers", route: "/assets/**", handler: headers, options: { "cache-control": "public, max-age=31536000, immutable" } }], $1 = [{ name: "cache", route: "/**", handler: cache, options: false }, { name: "headers", route: "/**", handler: headers, options: { "Cache-Control": "no-cache" } }, { name: "isr", route: "/**", options: false }], $2 = [{ name: "cache", route: "/**/*.js", handler: cache, options: { "maxAge": 86400 } }], $3 = [{ name: "cache", route: "/**/*.css", handler: cache, options: { "maxAge": 86400 } }], $4 = [{ name: "cache", route: "/**/*.json", handler: cache, options: { "maxAge": 3600 } }];
  return (m, p) => {
    let r = [];
    ...
    r.unshift({ data: $3, params: { "_": s.slice(1).join("/") } });
    r.unshift({ data: $4, params: { "_": s.slice(1).join("/") } });
    return r;
  };
})();
const _lazy_apCoCn = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
const findRoute = /* @__PURE__ */ (() => {
  const data = { route: "/**", handler: _lazy_apCoCn };
  return ((_m, p) => {
